...
@section('content')
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <button type="button" id="create" class="btn btn-primary"><i class="fa fa-plus"></i>Create Courier</button>
                </div>
                <div class="box-body">
                    <table id="couriers" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            @for ($i = 0; $i < count($couriers); $i++)
                                <tr>
                                    <td>{{ $i + 1 }}</td>
                                    <td>{{ $couriers[$i]->courier }}</td>
                                    <td>
                                        <form action="/admin/courier/{{ $couriers[$i]->id }}/edit" method="GET" class="btn-group">
                                            <button type="submit" class="btn btn-warning" title="Edit">
                                                <i class="fa fa-pencil-square-o"></i>
                                            </button>
                                        </form>
                                        <form action="/admin/courier/{{ $couriers[$i]->id }}" method="POST" class="btn-group">
                                            @csrf
                                            @method("DELETE")
    ...
    <div id="modal" class="modal-wrapper">
        ...
        <div class="box box-primary">
            ...
            <form action="/admin/courier" method="POST" id="create-form">
                @csrf
