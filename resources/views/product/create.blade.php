            ...
            <form action="/admin/product" method="POST">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" min="1" id="stock" name="stock" class="form-control" placeholder="Product stock" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" name="description" class="form-control" placeholder="Product description" rows="5"></textarea>
                    </div>
                </div>
